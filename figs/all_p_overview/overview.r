...
if (!exists("the.data"))
{
the.data <- read.table("summary_freq_dep_all_p.csv",sep=";",header=T)
the.data[,"f_2"] <- 1.0 - the.data[,"f_0"] - the.data[,"f_1"]

the.data[,"v"] <- round(1.0 - the.data[,"mh_1"],3)

the.data[,"c"] <- round(2 * the.data[,"mh_2"] + the.data[,"v"] - 2,3)
...
print(wireframe((f_2 + f_1) ~ c * v | d * err,data=the.data,
        zlim=c(0,1),
...
print(wireframe(vd_0 ~ c * v | d * err,data=the.data,
...
print(wireframe(vh_2 - vd_1 ~ c * v | d * err,data=the.data,
        zlim=c(0,0.6),
        zlab=list(rot=100,label="RV Dove on DD patch"),
        strip=function(strip.levels,...) { strip.default(strip.levels=T,...) },
        default.scales=list(arrows=F)
...
print(wireframe(vd_1 ~ c * v | d * err,data=the.data,
...
print(wireframe(vh_1 ~ c * v | d * err,data=the.data,
...
print(wireframe(vh_2 ~ c * v | d * err,data=the.data,
...
print(wireframe(pdh0 ~ c * v | d * err,data=the.data,
        zlim=c(0,1),
...
print(wireframe(pdh1 ~ c * v | d * err,data=the.data,
        zlim=c(0,1),
        strip=function(strip.levels,...) { strip.default(strip.levels=T,...) },
        default.scales=list(arrows=F)
        ))
...
print(wireframe(phh1 ~ c * v | d * err,data=the.data,
        zlim=c(0,1),
        strip=function(strip.levels,...) { strip.default(strip.levels=T,...) },
        default.scales=list(arrows=F)
        ))
...
print(wireframe(phh2 ~ c * v | d * err,data=the.data,
        zlim=c(0,1),
        strip=function(strip.levels,...) { strip.default(strip.levels=T,...) },
        default.scales=list(arrows=F)
        ))
...
print(wireframe(rv.hawk.m ~ c * v | d * err,data=the.data,
        strip=function(strip.levels,...) { strip.default(strip.levels=T,...) },
        default.scales=list(arrows=F)
        ))
dev.off()
...
print(wireframe(rv.dove.m ~ c * v | d * err,data=the.data,
        strip=function(strip.levels,...) { strip.default(strip.levels=T,...) },
        default.scales=list(arrows=F)
        ))
dev.off()
...
print(wireframe(rv.hawk.m - rv.dove.m ~ c * v | d * err,data=the.data,
        strip=function(strip.levels,...) { strip.default(strip.levels=T,...) },
        default.scales=list(arrows=F)
        ))
dev.off()
...
print(wireframe(diff.hd ~ c * v | d * err,data=the.data,
        zlim=c(0,1),
        strip=function(strip.levels,...) { strip.default(strip.levels=T,...) },
        default.scales=list(arrows=F)
        ))
