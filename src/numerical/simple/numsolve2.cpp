...
double vd_1 = ((struct rparams *) params)->vd_1;
	...
	for (int rtime=0; rtime<1e07; ++rtime) {
		rhhtplus1 = bound01(((((1 - d)*((1 - err)*phh + (err*(2*pdh + 2*phh))/4.))/2. + ((1 - d)*((1 - err)*pdh + (err*(2*pdh + 2*phh))/4.)*rhd)/2.)*f_1*md_1 + (1 - d)*((1 - err)*phh + (err*(2*pdh + 2*phh))/4.)*(1 + rhh)*(1 - f_0 - f_1)*mh_2)/((f_1*((1 - d)*((1 - err)*pdh + (1 - err)*phh + (err*(2*pdh + 2*phh))/2.) + d*(2*((1 - err)*pdh + (err*(2*pdh + 2*phh))/4.)*f_0 + 2*((1 - err)*phh + (err*(2*pdh + 2*phh))/4.)*(1 - f_0 - f_1) + ((1 - err)*pdh + (1 - err)*phh + (err*(2*pdh + 2*phh))/2.)*f_1))*md_1)/2. + (1 - f_0 - f_1)*(2*(1 - d)*((1 - err)*phh + (err*(2*pdh + 2*phh))/4.) + d*(2*((1 - err)*pdh + (err*(2*pdh + 2*phh))/4.)*f_0 + 2*((1 - err)*phh + (err*(2*pdh + 2*phh))/4.)*(1 - f_0 - f_1) + ((1 - err)*pdh + (1 - err)*phh + (err*(2*pdh + 2*phh))/2.)*f_1))*mh_2));
		rhdtplus1 = bound01(((1 - d)*((1 - err)*pdh + (err*(2*pdh + 2*phh))/4.)*(1 + rdd)*f_0*md_0 + (((1 - d)*(1 - (1 - err)*phh - (err*(2*pdh + 2*phh))/4.))/2. + ((1 - d)*(1 - (1 - err)*pdh - (err*(2*pdh + 2*phh))/4.)*rhd)/2.)*f_1*md_1 + (((1 - d)*((1 - err)*pdh + (err*(2*pdh + 2*phh))/4.))/2. + ((1 - d)*((1 - err)*phh + (err*(2*pdh + 2*phh))/4.)*rhd)/2.)*f_1*mh_1 + (1 - d)*(1 - (1 - err)*phh - (err*(2*pdh + 2*phh))/4.)*(1 + rhh)*(1 - f_0 - f_1)*mh_2)/(f_0*(2*(1 - d)*((1 - err)*pdh + (err*(2*pdh + 2*phh))/4.) + d*(2*((1 - err)*pdh + (err*(2*pdh + 2*phh))/4.)*f_0 + 2*((1 - err)*phh + (err*(2*pdh + 2*phh))/4.)*(1 - f_0 - f_1) + ((1 - err)*pdh + (1 - err)*phh + (err*(2*pdh + 2*phh))/2.)*f_1))*md_0 + f_1*(1 + (-((1 - d)*((1 - err)*pdh + (1 - err)*phh + (err*(2*pdh + 2*phh))/2.)) - d*(2*((1 - err)*pdh + (err*(2*pdh + 2*phh))/4.)*f_0 + 2*((1 - err)*phh + (err*(2*pdh + 2*phh))/4.)*(1 - f_0 - f_1) + ((1 - err)*pdh + (1 - err)*phh + (err*(2*pdh + 2*phh))/2.)*f_1))/2.)*md_1 + (f_1*((1 - d)*((1 - err)*pdh + (1 - err)*phh + (err*(2*pdh + 2*phh))/2.) + d*(2*((1 - err)*pdh + (err*(2*pdh + 2*phh))/4.)*f_0 + 2*((1 - err)*phh + (err*(2*pdh + 2*phh))/4.)*(1 - f_0 - f_1) + ((1 - err)*pdh + (1 - err)*phh + (err*(2*pdh + 2*phh))/2.)*f_1))*mh_1)/2. + 2*(1 - f_0 - f_1)*(1 + (-2*(1 - d)*((1 - err)*phh + (err*(2*pdh + 2*phh))/4.) - d*(2*((1 - err)*pdh + (err*(2*pdh + 2*phh))/4.)*f_0 + 2*((1 - err)*phh + (err*(2*pdh + 2*phh))/4.)*(1 - f_0 - f_1) + ((1 - err)*pdh + (1 - err)*phh + (err*(2*pdh + 2*phh))/2.)*f_1))/2.)*mh_2));
		rddtplus1 = bound01(((1 - d)*(1 - (1 - err)*pdh - (err*(2*pdh + 2*phh))/4.)*(1 + rdd)*f_0*md_0 + (((1 - d)*(1 - (1 - err)*pdh - (err*(2*pdh + 2*phh))/4.))/2. + ((1 - d)*(1 - (1 - err)*phh - (err*(2*pdh + 2*phh))/4.)*rhd)/2.)*f_1*mh_1)/(2*f_0*(1 + (-2*(1 - d)*((1 - err)*pdh + (err*(2*pdh + 2*phh))/4.) - d*(2*((1 - err)*pdh + (err*(2*pdh + 2*phh))/4.)*f_0 + 2*((1 - err)*phh + (err*(2*pdh + 2*phh))/4.)*(1 - f_0 - f_1) + ((1 - err)*pdh + (1 - err)*phh + (err*(2*pdh + 2*phh))/2.)*f_1))/2.)*md_0 + f_1*(1 + (-((1 - d)*((1 - err)*pdh + (1 - err)*phh + (err*(2*pdh + 2*phh))/2.)) - d*(2*((1 - err)*pdh + (err*(2*pdh + 2*phh))/4.)*f_0 + 2*((1 - err)*phh + (err*(2*pdh + 2*phh))/4.)*(1 - f_0 - f_1) + ((1 - err)*pdh + (1 - err)*phh + (err*(2*pdh + 2*phh))/2.)*f_1))/2.)*mh_1));
